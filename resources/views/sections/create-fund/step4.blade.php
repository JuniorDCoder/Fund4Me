<div class="p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- Other Payment Method 1 -->
        <div class="flex items-center p-4 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow">
            <img src="https://via.placeholder.com/64" alt="Payment Method 1" class="w-16 h-16 mr-4">
            <div>
                <h4 class="text-xl font-semibold">Payment Method 1</h4>
                <p class="text-gray-600">Description for payment method 1.</p>
            </div>
        </div>

        <!-- Other Payment Method 2 -->
        <div class="flex items-center p-4 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow">
            <img src="https://via.placeholder.com/64" alt="Payment Method 2" class="w-16 h-16 mr-4">
            <div>
                <h4 class="text-xl font-semibold">Payment Method 2</h4>
                <p class="text-gray-600">Description for payment method 2.</p>
            </div>
        </div>
    </div>
</div>
