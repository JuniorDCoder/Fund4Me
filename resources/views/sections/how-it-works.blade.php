<section class="py-12 sm:py-16 lg:py-20 xl:py-24">
    <div class="mx-auto px-4">
        <div class="">
            ...
            <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Welcome to Fund4Me!</h2>
            <p class="mx-auto mt-4 text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">
                Follow these simple steps to get started with your campaign or vote.
            </p>
        </div>
        <ul class="mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-7xl lg:grid-cols-4">
            <li class="flex-start group relative flex lg:flex-col">
                ...
                <div class="ml-6 lg:ml-0 lg:mt-10">
                    ...
                    <h4 class="mt-2 text-base text-gray-700">Sign up to start your journey. Provide your details and verify your email to activate your account.</h4>
                </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
                <span
                ...
                <div class="ml-6 lg:ml-0 lg:mt-10">
                    <h3
                        class="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                        Set Up Your Campaign or Vote
                    </h3>
                    <h4 class="mt-2 text-base text-gray-700">Choose whether you want to start a crowdfunding campaign or initiate a vote. Fill in the necessary details like title, description, and goal amount or voting options.</h4>
                </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
                <span
                ...
                <div class="ml-6 lg:ml-0 lg:mt-10">
                    ...
                    <h4 class="mt-2 text-base text-gray-700">Promote your campaign or voting event by sharing the link with your friends, family, and wider community to gain support and participation.</h4>
                </div>
            </li>
            <li class="flex-start group relative flex lg:flex-col">
                <div
                ...
                <div class="ml-6 lg:ml-0 lg:mt-10">
                    ...
                    <h4 class="mt-2 text-base text-gray-700">Monitor the progress of your campaign or vote through your dashboard. Engage with contributors or voters by providing updates and responding to their comments.</h4>
                </div>
            </li>
        </ul>
    </div>
