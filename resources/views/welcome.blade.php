    ...
    <section class="bg-white overflow-hidden">
        <div class="grid py-20 mx-5 md:mx-auto gap-8 md:py-16 md:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center rounded-lg text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Get started
